...
export declare type token = "a" | "A" | "D" | "F" | "G" | "H" | "J" | "K" | "M" | "S" | "U" | "W" | "Y" | "Z" | "d" | "h" | "i" | "j" | "l" | "m" | "n" | "s" | "u" | "w" | "y";
export declare const monthToStr: (monthNumber: number, shorthand: boolean, locale: Locale) => string;
export declare type RevFormatFn = (date: Date, data: string, locale: Locale, options: ParsedOptions) => Date | void | undefined;
