...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var baseTwoDigitsYear = 2000;
    var revFormat = {
        a: function (dateObj, alteredYear, _, options) {
    ...
    var formats = {
        ...
        a: function (date, _, options) {
            return pad(date.getFullYear() + options.alterYear, 2);
        },
        // get full altered year padded (0001-9999)
        A: function (date, _, options) {
            return pad(date.getFullYear() + options.alterYear, 4);
        },
        // get the date in UTC
            ...
            if (date instanceof Date)
                ...
                if (datestr === "today") {
                    ...
                    ops.forEach(function (_a) {
                        ...
                        return (parsedDate =
                            fn(parsedDate, val, locale, config) || parsedDate);
                    });
    ...
    function FlatpickrInstance(element, instanceConfig) {
        ...
        function onYearInput(event) {
            ...
            var year = parseInt(eventTarget.value) + (event.delta || 0) - self.config.alterYear;
            if (year / 1000 > 1 ||
